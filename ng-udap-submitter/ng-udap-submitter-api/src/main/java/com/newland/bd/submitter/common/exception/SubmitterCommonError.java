...
public enum SubmitterCommonError implements ErrorCode {
    C_COMMON_00001("C-COMMON-00001", "出现运行时异常", "运行时异常[%s]"),
    C_COMMON_00002("C-COMMON-00002", "缺少提交器参数", "缺少提交器参数[%s]"),
    ...
    private SubmitterCommonError(String code, String desc, String msg) {
        this.code = code;
        this.desc = desc;
        this.msg = msg;
    }
